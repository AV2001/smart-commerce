...
def get_products_from_prompt(prompt):
    messages = [
        {
            "role": "system",
            "content": "You are a helpful shopping assistant. You will extract the key information from the user's message and use the functions provided to you to finish the task.",
        },
